...
List<RestaurantSummary> restaurantSummaryFromJson(String str) =>
    List<RestaurantSummary>.from(
        json.decode(str).map((x) => RestaurantSummary.fromJson(x)));

String restaurantSummaryToJson(List<RestaurantSummary> data) =>
